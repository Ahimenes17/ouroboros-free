...
CFG = {
    ...
    "OUROBOROS_MODEL_FALLBACK_LIST": "qwen/qwen3-next-80b-a3b-instruct:free,deepseek/deepseek-chat-v3-0324:free",
    # Infrastructure
...
| `OUROBOROS_MODEL_FALLBACK_LIST` | `qwen/qwen3-next-80b-a3b-instruct:free,deepseek/deepseek-chat-v3-0324:free` | Fallback model chain for empty responses - FREE |
